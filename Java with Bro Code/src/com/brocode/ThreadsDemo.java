...
public abstract class ThreadsDemo {
    public static void main(String[] args) throws InterruptedException {
        /*
        thread = A thread of execution in a program (kind of like a virtual
                ...
                Daemon thread is a lwo priority thread that runs in background to perform tasks such as garbage collection
